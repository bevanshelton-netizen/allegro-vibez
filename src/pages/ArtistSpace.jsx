...
export default function ArtistSpace(){
  ...
  return <main className="artist-public-space">
    ...
    <section className="artist-public-grid">
      ...
      <article><div className="eyebrow">BOOKINGS</div><h2>Work with {name}</h2><div className="artist-booking-cta"><Link className="primary inline" to={'/artist/'+artistId+'/book'}>BOOK THIS ARTIST</Link><p>Submit event, travel, production and budget details directly into the artist's ALLEGRO Booking Desk.</p></div></article>
