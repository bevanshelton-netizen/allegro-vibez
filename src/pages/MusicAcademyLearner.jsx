...
export default function MusicAcademyLearner(){
  ...
  return <main className="ma-learner">
    ...
    <section className="ma-next-lessons">
      ...
      <article><span className="ma-kicker">FULL SCHOOL</span><h3>R99 Launch Access</h3><p>Complete instrument pathways, guided practice and future advanced coaching.</p><Link to="/music-academy#pricing">View plan →</Link></article>
    </section>
  </main>
}
