...
values
  ('free','Free',0,'ZAR',10,'["Up to 5 active releases","Creator profile","Basic rights ledger"]'),
  ('pro','Pro',179,'ZAR',8,'["Unlimited releases","Advanced royalty dashboard","Priority review","Expanded creator tools"]'),
  ('label','Label',899,'ZAR',6,'["Multi-artist operations","Label reporting","Team workflows","Priority support"]')
