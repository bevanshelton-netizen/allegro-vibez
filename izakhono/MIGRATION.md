...
From an IZAKHONO Core v0.3+ release on the server:
...
- Release media is stored in a private bucket.
...
5. Private release upload/download.
6. Public published-release discovery without draft leakage.
7. Payout validation.
