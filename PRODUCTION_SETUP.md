...
4. Complete a PayFast sandbox plan purchase and confirm the subscription activates only after the validated notification.
5. Replay/retry the same notification and confirm the subscription period is not extended a second time.
6. Add a royalty entry, confirm wallet balances and request a payout.
7. Confirm a non-admin cannot access moderation or payout operations.
8. Confirm Privacy, Terms, reset-password and unknown-route pages work on direct navigation.
